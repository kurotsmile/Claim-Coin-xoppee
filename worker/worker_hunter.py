...
#sys.path.append('/service/shopee_hunter_live')
from PyQt5.QtCore import QObject, pyqtSignal, QRunnable
#from service.shopee.shopee_version_1 import ShopeeVersion1
from service.shopee_hunter.hunter_v1 import Shopee
class WorkerSignals(QObject):
    finished = pyqtSignal(str, list)
    error = pyqtSignal(str, list)
class WorkerHunterRun(QRunnable):
    ...
    def run(self): 
        try:
            ...
            print(f'{formatted_time} --- {self.phone_serial} error: {e}')
